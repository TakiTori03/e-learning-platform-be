...
public class MessageKeys {
    ...
    public static final String ACCOUNT_IS_DELETED = "account.deleted";
    // validation
    ...
    public static final String Product_SKU_EXISTED = "product_sku_existed";
    ...
    public static final String ACCOUNT_NOT_ACTIVATED = "account.not.actived";
    public static final String ACCOUNT_ACTIVATED = "account.activated";
    public static final String ACCOUNT_RESEND_ACTIVATEDKEY_SUCCESS = "account.resend.activated_key.success";
    public static final String ACCOUNT_RESETKEY_ALREADY_SENT = "account.reset_key.already.sent";
    // token
    ...
    public static final String TOKEN_INVALID = "user.token.invalid";
    public static final String SESSION_NOT_EXISTED = "user.session.not_found";
